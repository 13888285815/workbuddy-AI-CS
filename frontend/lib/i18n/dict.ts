...
export const DICT: Record<Lang, Record<I18nKey, string>> = {
  "zh-CN": {
    ...
    "home.cta.title": "准备好把 WorkBuddy AI 接到你的产品里了吗？",
    "home.cta.subtitle": "从开源仓库开始，或用在线 Demo 先看交互与能力边界。",
    "home.cta.starRepo": "Star / Fork 仓库",
    "home.cta.feedback": "建议反馈",
    "home.cta.mailSubject": "WorkBuddy AI 建议反馈",
    "home.cta.mailBody":
      "你好，我想反馈：\n\n1）问题/建议：\n2）影响范围/环境：\n3）期望结果：\n\n---\n联系方式（可选）：",
    "footer.blurb":
      "WorkBuddy AI 是一款 AI 驱动的智能客服系统，融合 AI 技术与人工客服，为企业提供高效、智能的客户服务解决方案。",
  ...
  en: {
    ...
    "home.cta.title": "Ready to wire WorkBuddy AI into your product?",
    ...
    "home.cta.mailSubject": "WorkBuddy AI feedback",
    "home.cta.mailBody":
      "Hi,\n\n1) Issue or suggestion:\n2) Scope / environment:\n3) Expected outcome:\n\n---\nContact (optional):",
    "footer.blurb":
      "WorkBuddy AI is an AI-powered customer support stack that blends automation and human agents for efficient, modern service.",
